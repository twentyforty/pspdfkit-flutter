...
public class InstantExampleViewController: UITableViewController {
...
extension InstantExampleViewController: UITextFieldDelegate {
    ...
    public func textFieldShouldReturn(_ textField: UITextField) -> Bool {
        ...
        instantDocumentPresenter.joinExistingSession(withURL: text.trimmingCharacters(in: .whitespacesAndNewlines))
        return true
    }
}
