...
@objc class InstantDocumentViewController: InstantViewController {
    ...
    init(documentInfo: InstantDocumentInfo) throws {
        /*
         ...
         The `Document` you get from Instant does not retain the objects that create it,
